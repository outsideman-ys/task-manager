...
import ru.yegorsmirnov.testtask.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public AuthorizationService authorizationService() {
        return new AuthorizationService(taskRepository, commentaryRepository);
    }
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(request -> request
                        ...
                        .requestMatchers("/auth/**", "/swagger.yaml","/swagger-ui.html", "/swagger-ui/**", "/swagger-resources/**", "/v3/api-docs/**").permitAll()
